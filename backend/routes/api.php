...
use HiEvents\Http\Actions\Events\Swish\MassRefund\GetSwishMassRefundRunAction;
use HiEvents\Http\Actions\Events\Swish\MassRefund\GetSwishMassRefundRunsAction;
use HiEvents\Http\Actions\Events\Swish\MassRefund\PreviewSwishMassRefundAction;
use HiEvents\Http\Actions\Events\Swish\MassRefund\RetrySwishMassRefundAction;
use HiEvents\Http\Actions\Events\Swish\MassRefund\StartSwishMassRefundAction;
...
use HiEvents\Http\Actions\Organizers\Billing\UpsertOrganizerBillingSettingsAction;
...
$router->middleware(['auth:api'])->group(
    function (Router $router): void {
        ...
        $router->get('/organizers/{organizerId}/billing-settings', GetOrganizerBillingSettingsAction::class);
        $router->put('/organizers/{organizerId}/billing-settings', UpsertOrganizerBillingSettingsAction::class);
        ...
        $router->get('/events/{event_id}/swish-mass-refunds/preview', PreviewSwishMassRefundAction::class);
        $router->get('/events/{event_id}/swish-mass-refunds', GetSwishMassRefundRunsAction::class);
        $router->post('/events/{event_id}/swish-mass-refunds', StartSwishMassRefundAction::class);
        $router->get('/events/{event_id}/swish-mass-refunds/{run_id}', GetSwishMassRefundRunAction::class);
        $router->post('/events/{event_id}/swish-mass-refunds/{run_id}/retry', RetrySwishMassRefundAction::class);
